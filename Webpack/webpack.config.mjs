  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // 'react-native-reanimated': new URL('./node_modules/react-native-reanimated/src/index.ts', import.meta.url) .pathname,
      },
    ...
    plugins: [
      ...
      new Repack.RepackPlugin({
        ...
        output: {
          bundleFilename,
          // sourceMapFilename, // no need source file
          // assetsPath, // no need asset folder
        },
      }),
      ...
      new Repack.plugins.ModuleFederationPlugin({
        ...
        shared: {
          ...
          realm: {singleton: true, eager: true, requiredVersion: '*'},
          '@realm/react': {singleton: true, eager: true, requiredVersion: '*'},
